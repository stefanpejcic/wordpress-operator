...
func (r *WordpressReconciler) newServiceSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("Service", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
