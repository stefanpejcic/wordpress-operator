...
func (r *WordpressReconciler) newMediaPVCSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("MediaPVC", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
