...
func (r *WordpressReconciler) newIngressSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("Ingress", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
