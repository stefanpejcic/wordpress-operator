...
func (r *WordpressReconciler) newDBUpgradeJobSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("DBUpgradeJob", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
