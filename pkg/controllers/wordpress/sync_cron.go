...
func (r *WordpressReconciler) newWPCronSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("WPCron", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
