...
func (r *WordpressReconciler) newSecretSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("Secret", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
