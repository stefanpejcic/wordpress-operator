...
func (r *WordpressReconciler) newCodePVCSyncer(wp *wordpress.Wordpress) syncer.Interface {
	...
	return syncer.NewObjectSyncer("CodePVC", wp.Unwrap(), obj, r, r.scheme, func(existing runtime.Object) error {
